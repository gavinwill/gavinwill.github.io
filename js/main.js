...
function commander(cmd) {
  ...
  switch (cmd.toLowerCase()) {
    ...
    case "projects":
      ...
      break;
    case "email":
      addLine('Opening mailto:<a href="mailto:g@gavinwill.me.uk">g@gavinwill.me.uk</a>...', "color2", 80);
      newTab(email);
      break;
    // socials
    case "linkedin":
    ...
    case "vi":
      ...
      break;
    case "vim":
      addLine("<span class=\"inherit\">why use vim? Try <span class=\"command\">'nano'</span> instead</span>", "color2", 80);
      break;
    case "nano":
      addLine("<span class=\"inherit\">really? nano? You should be using <span class=\"command\">'vim'</span></span>", "color2", 80);
      break;
    case "sudo":
